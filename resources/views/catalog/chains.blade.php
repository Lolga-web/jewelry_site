...
@section('content')
    ...
    <p class="main_content_text">
        Длина цепи и тощина плетения - в зависимости от Ваших пожеланий.
    </p>
    ...
    <h2 class="main_content_title">Шнурки</h2>

    <p class="main_content_text">
        Длина и тощина - в зависимости от Ваших пожеланий.
        Материал шнурка капрон или кожа. Количество и модели вставок любые.
    </p>
